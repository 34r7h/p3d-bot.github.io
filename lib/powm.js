...
// CONSTANTS
var contractAddress = '0x319735ae0c0c6c71798d9eae55938457bd83c188'
// var donationAddress = '0x11e52c75998fe2E7928B191bfc5B25937Ca16741'
...
window.addEventListener('load', function () {
  ...
  function fund (address, truthiness, amount) {
    if (walletMode === 'metamask') {
      contract.buyPill(getCookie('masternode').split(';')[0], truthiness, {
        value: convertEthToWei(amount)
      }, function (e, r) {
        console.log(e, r)
      })
...
function updateData () {
  ...
  contract.redPillAmount(function (e, r) {
    ...
    $('.red-pill-amount').text(Number(redPillAmount.toFixed(0)).toLocaleString());
  })

  contract.bluePillAmount(function (e, r) {
    let bluePillAmount = r / 1e18;
    $('.blue-pill-amount').text(Number(bluePillAmount.toFixed(0)).toLocaleString());
  })
